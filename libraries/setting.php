...
$GLOBAL['baiviet'][$nametype]['cat'] = true;
	...
	$nametype='bg_dangkymobile';

	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Background đăng ký mobile';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Background đăng ký mobile';
	...
	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Background danh mục dự án';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Background danh mục dự án';
