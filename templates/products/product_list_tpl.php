                                                ...
                                                <div class="wrap-productshot__boxbc d-flex flex-column p-relative">
                                                    ...
                                                    <div class="wrap-productshot__boxbc-content d-flex flex-column">
                                                        ...
                                                        <div
                                                            ...
                                                            <span
                                                                class="wrap-productshot__boxbc-content-price-news col-6"><?=($v["giaban"]!=0) ? $func->changeMoney($v["giaban"],$lang):'Liên hệ';?></span>

                                                            <del
                                                                class="wrap-productshot__boxbc-content-price-old col-6"><?=($v["giacu"]!=0) ?  $func->changeMoney($v["giacu"],$lang):'';?></del>
                                                    ...
                                                    <div class="wrap-productshot__boxbc-bottom d-flex flex-wrap">
                                                        ...
                                                        <a href="<?=$v["type"]?>/<?=$alias_l.$v["tenkhongdau"]?>"
                                                            class="col-6 js-addcart-buynow" data-id="<?=$v["id"]?>"
                                                            data-qty="1"><i class="fa-light fa-cart-shopping"></i> Xem
                                                            ngay</a>
